...
import shiftingPerspectives from "../../assets/images/desktop/shifting-perspectives.jpg";
import shiftingPerspectivesExpand from "../../assets/images/desktop/shifting-perspectives-expand.jpg";
...
import goldenAge from "../../assets/images/desktop/golden-age.jpg";
import goldenAgeExpand from "../../assets/images/desktop/golden-age-expand.jpg";
import sexWork from "../../assets/images/desktop/sex-work.jpg";
import sexWorkExpand from "../../assets/images/desktop/sex-work-expand.jpg";
...
import culinary from "../../assets/images/desktop/culinary-canvas.jpg";
import culinaryExpand from "../../assets/images/desktop/culinary-canvas-expand.png";
import platesPurpose from "../../assets/images/desktop/plates-purpose.jpg";
import platesPurposeExpand from "../../assets/images/desktop/plates-purpose-expand.png";
...
import grentperez from "../../assets/images/desktop/grentperez.jpg";
import grentperezExpand from "../../assets/images/desktop/grentperez-expand.png";
import huxleys from "../../assets/images/desktop/huxleys.jpg";
import huxleysExpand from "../../assets/images/desktop/huxleys-expand.jpg";
...
import mojuThumb from "../../assets/images/desktop/moju-thumb.png";
...
import residenceThumb from "../../assets/images/desktop/vivid-residence-thumb.png";
import aster from "../../assets/images/desktop/aster.jpg";
import asterThumb from "../../assets/images/desktop/aster-thumb.jpg";
...
import budjerahThumb from "../../assets/images/desktop/budjerah-thumb.jpg";
...
const data: ColumnData[] = [
  {
    id: 1,
    heading: {title: 'Ideas', column: 1, position: "top"},
    colour: "bg-white",
    columnCodes: ["F", "H", "I", "A"],
    pin: "true",
    column1: [
    ...
    column2: [
      {
        ...
        date: 8,
        location: "Sydney CBD",
        title: "AI Will Destroy Humanity: </br> A Future Science Debate",
        ...
        imagePosition: "top",
        imageHeight: "lg:h-[15vw] object-bottom",
      },

      {
        ...
        image:shiftingPerspectivesExpand,
        imageExcerpt:shiftingPerspectives,
        imagePosition: "top",
        imageHeight: "lg:h-[12vw]",
      },
    ...
    column3: [
      {
        ...
        date: 18,
        location: "Sydney CBD",
        title: "A THOUSAND WAYS: </br>An Encounter",
        excerpt: "Is it theatre? Civic encounter? This Vivid Sydney 2024 event is both of those — and so much more. A THOUSAND WAYS is an event unlike any other. ",
        body: "<p>Is it theatre? Civic encounter? This Vivid Sydney 2024 event is both of those — and so much more. A THOUSAND WAYS is an event unlike any other. In this solo experience, it’s just you and one other person, who is a stranger to you.</p><p>You will sit across from one another, separated by a glass partition, and be guided through the encounter by a stack of cards. The experience, that examines the line between strangeness and kinship, distance and proximity, has been created by New York’s 600 Highwaymen, world renowned for its radical approach to making live art, and constructing events that create intimacy among strangers.</p><p>“It is a joy; even if it scares you, go. This is a work of inquisitive humanity and profound gentleness, which over the course of an hour buffs away the armour that lets us proceed through our days brusque, numb and antagonistic.” The New York Times, 2021</p><p><em>A THOUSAND WAYS will be held at various times between May 29 and June 10. Tickets from $39 (recommended ages 16 and up). Venue: State Library of New South Wales, 1 Shakespeare Place, Sydney.</em></p>",
    ...
    column4: [
      {
        ...
        image: goldenAgeExpand,
        imagePosition: "top",
        imageExcerpt: goldenAge,
        imageHeight: "lg:h-[17vw]",
      },
      {
        id: 7,
        date: 7,
        location: "Kings Cross",
        title: "Sex Work: A Legal and </br>Social History",
        ...
        imageHeight: "lg:h-[14vw] object-top",
        soldOut: true
      },
    ]
  },
  {
    id: 2,
    heading: {title: 'Food', column: 2, position: "bottom"},
    colour: "bg-white",
    columnCodes: ["A", "E", "A", "I"],
    pin: "",
    column1: [
      {
        ...
        title: "The Art of </br>Deep Listening",
        excerpt: "What better place to work on your focus and deep-listening skills than the serene setting of the Royal Botanic Garden Sydney? Meditation facilitator and creative consultant Steve Pozel and Timothea Goddard, one of Australia’s most",
      ...
      },
      {
        ...
        date: 19,
        location: "Ultimo",
        title: "Say My Name: The </br>Humanity of Names",
        excerpt: "When Juliet asked Romeo: “What’s in a name?”, she sought to minimise the importance of names. However, in this panel event, the experts will posit that names are an essential part of our identity, as they carry deep personal,",
    ...
    column3: [
      {
        id: 12,
        date: 25,
        location: "Sydney and </br>Bulletin Place",
        title: "VividPlace Food Trail",
        excerpt: "Eat your way around the world from within some of Sydney’s most charming laneways, which will host some of Australia’s top chefs, restaurateurs and bartenders throughout Vivid Sydney 2024. Minutes from the world-famous ",
    ...
    column4: [
      {
        ...
        title: "Plates with Purpose: </br> A Taste of Ukraine",
        ...
        image:platesPurposeExpand,
        // imagePosition:"top",
        // imageExcerpt:platesPurpose,
        imageHeight: "lg:h-[14vw]",
      },
     
      {
        ...
        date: 29,
        location: "Bennelong Point",
        title: "Aurorae at </br>Bennelong Bar",
     ...
     
      {
        ...
        excerpt: "Top chefs? Tick. Delicious vegetarian menu reducing food waste? Tick. Helping others? Huge tick! Our Shared Humanity takes over Refettorio OzHarvest for several evenings during Vivid Sydney 2024, to offer up an ",
  ...
  {
    id: 3,
    heading: {title: 'Music', column: 2, position: 'top'},
    columnCodes: ["A", "F", "D", "B"],
    colour: "bg-white",
    pin: "",
    column1: [

      {
        ...
        excerpt: "Humanity reaches new heights at this exclusive Vivid Sydney experience at InterContinental Sydney’s premium rooftop bar. Enjoy the spectacular Light Walk 32 storeys below as you experience Aster’s thoughtful interpretation of",
        ...
        image: aster,
        imagePosition:"top",
        imageExcerpt: asterThumb,
        imageHeight: "lg:h-[16vw]",
      },
      {
        id: 19,
        date: 25,
        location: "Sydney CBD",
        title: "Atelier by Sofitel: A </br>Culinary Connection",
    ...
    column2: [
      {
        ...
        excerpt: "Join the Elite Kiki House of Silky as the Ballroom collective celebrates five years of family, fashion, and voguing excellence at Vivid Sydney 2024. The Silkys has hosted some of the most fun",
    ...
    column3: [
      {
        ...
        imageHeight: "xxl:h-[18vh] lg:h-[15vw]",
      },
      {
        id: 22,
        date: 19,
  ...
  {
    id: 4,
    heading: {title:"", column:0, position: ""},
    columnCodes: ["D", "A", "B", "A"],
    colour: "bg-white",
    pin: "",
    column1: [
      ...
      },
      {
        ...
        location: "Machine Hall",
        title: "+WINDCHILL",
        excerpt: "Come and experience the very cutting-edge of music and performance that push the limits of RnB, electronic music, live instrumentation and visuals. +WINDCHILL features a roster of artists renowned for their experimental and genre-",
    ...
    column3: [
      ...
      },
      {
        id: 30,
        date: 25,
        location: "Vivid Sydney </br>Supper Club",
        title: "Divas Live:</br> A Night of Worship",
...

      {
        ...
        date: 7,
        location: "Vivid Sydney </br>Supper Club",
        title: "Rhys Nicholson + <br/>Georgia Mooney +</br> Nikki Britton",
    ...
    column4: [
      {
        ...
        image: moju,
        imagePosition: "bottom",
        imageExcerpt: mojuThumb,
        imageHeight: "xxl:h-[10vw]"
      },
      {
        id: 32,
        date: 17,
        ...
        excerpt: "Join hosts Rhys Nicholson and Georgia Mooney for a late-night live Game Show (read: unscripted anarchy)! They’ve tricked a line-up of the country’s best minds like Luke McGregor, Susie Youssef and Lewis Hobba to take part in",
  ...
  },
  {
    ...
    column1: [
      {
        ...
        excerpt: "Supper Club hosts Rhys Nicholson and Georgia Mooney are keen to explore the flip side of this year’s festival theme, Humanity. Enter: a night exploring tales of inhumanity. Gather round as Australia’s best raconteurs and musical artistes",
      ...
      },
      {
        ...
        excerpt: "Dip your well-dressed toe into a night of disco, fabulous fashion and left-of-field jokes. Come discover why TANZER is a fixture at some of the globe’s most exclusive parties as she spins a blend of culture-clash disco,",
    ...
    column2: [
      {
        ...
        excerpt: "Come and join the best adults-only kids’ party you’ve ever been to. There’ll be party hats, games, face-painting, craft, comedy and storytime (without the sitting on the floor part).",
      ...
      },
      {
        ...
        imageExcerpt: jalbu,
        free: true,
        imageHeight: "lg:h-[16vw] xxl:h-[13vw]"
      },
    ...
    column3: [
      {
        ...
        free: true,
        imageHeight: "lg:h-auto object-bottom"
      },
      {
        id: 39,
        date: 21,
    ...
    column4: [
      ...
      },
      {
        ...
        link2: "",
        image: budjerah,
        imageExcerpt: budjerahThumb,
        imagePosition:"bottom",
        imageHeight: "xl:h-[55vh]",
        free: true
      },
    ]
  },
