import afterFact from "../../assets/images/desktop/after-fact.jpg";
...
import culinaryExpand from "../../assets/images/desktop/culinary-canvas-expand.jpg";
import platesPurpose from "../../assets/images/desktop/plates-purpose.jpg";
import platesPurposeExpand from "../../assets/images/desktop/plates-purpose-expand.jpg";
...
import jalbu from "../../assets/images/desktop/jalbu.jpg";
import jalbuExpand from "../../assets/images/desktop/jalbu-expand.jpg";
...
import spectacular from "../../assets/images/desktop/spectacular.jpg";
import spectacularExpand from "../../assets/images/desktop/spectacular-expand.jpg";
...
import { ColumnDataTablet } from "../../types/index";



const data: ColumnDataTablet[] = [
  {
    id: 1,
    ...
    column1: [
      {
        ...
        link: "https://www.vividsydney.com/",
        link2: "https://www.vividsydney.com/event/food/vivid-residence",
        image: afterFactExpand,
        imageExcerpt: afterFactExpand,
        imagePosition: "top",
      },
    ],
    column2: [
      {
        ...
        imageExcerpt: aiWillDestroyExpand,
        imagePosition: "top",
      },
  ...
  {
    id: 2,
    heading: {title: 'Food', column: 3,  position:'bottom'},
    colour: "bg-white",
    columnCodes: ["B", "A", "B"],
    pin: "",
    column1: [
      {
        ...
        imagePosition: "top",
        imageExcerpt: goldenAgeExpand
      },
      {
        id: 7,
        date: 7,
        location: "Kings Cross",
        title: "Sex Work:</br> A Legal and Social History",
    ...
    column2: [
      ...
      },
      {
        ...
        date: 19,
        location: "Ultimo",
        title: "Say My Name: </br>The Humanity of Names",
    ...
    column3: [
      {
        ...
        imageExcerpt:vividFoodPlaceExpand,
        imagePosition:"bottom"
      },
  ...
  {
    id: 3,
    heading: {title: 'Music', column: 0, position:'top'},
    columnCodes: ["C", "A", "B"],
    colour: "bg-white",
    pin: "",
    column1: [
    ...
    column2: [
      ...
      },
      {
        ...
        date: 25,
        location: "Sydney CBD",
        title: "Atelier by Sofitel: </br>A Culinary Connection",
    ...
    column3: [

      {
        ...
        imagePosition:"bottom",
        imageExcerpt:platesPurposeExpand
      },
      // {
      //   id: 13,
      //   date: 17,
      //   location: "The Rocks",
      //   title: "Vivid Residence",
      //   excerpt: "For special sittings during the festival, renowned Brazilian chef Manoella Buffara, Latin America's Best Female Chef 2022, will be taking up residence at Ploós.",
      //   body: "<p>For special sittings during the festival, renowned Brazilian chef Manoella Buffara, Latin America's Best Female Chef 2022, will be taking up residence at Ploós.</p><p>Perfectly located in The Rocks, this Vivid Sydney 2024 exclusive puts you at the heart of the action as Buffara joins forces with Ploós executive chef Peter Conistis to serve up intricate, elegant and unique dishes across her two-week Vivid Residence.</p><p>Her focus on seasonal, hyperlocal and sustainable ingredients will spotlight the quality and diversity of NSW produce, all served with a distinctly Brazilian twist. It’s also a chance to see a visionary flex her creativity as she works with new ingredients and in a collaborative context.</p><p><em>Vivid Residence will have multiple sittings between May 24 and June 2. Tickets from $320. Venue: Bay 7, 7-27 Circular Quay W, The Rocks.</em></p>",
      //   link: "https://www.vividsydney.com/",
      //   link2: "https://www.vividsydney.com/event/food/vivid-residence",
      //   image: residence,
      //   // imageExcerpt: residenceThumb,
      //   // imagePosition: "top"
      // }, 
    ], 
  },
  {
    id: 4,
    heading: {title:"Music", column:1, position:'top'},
    columnCodes: ["A", "A", "B"],
    colour: "bg-white",
    pin: "",
    column1: [
    ...
    column2: [
      {
        ...
        imagePosition: "top",
        imageExcerpt: clubBroadwayExpand
      },
      {
        id: 37,
        date: 17,
